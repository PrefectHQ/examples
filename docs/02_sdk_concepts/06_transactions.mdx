<a href="https://github.com/griggz/prefect-examples-test/blob/main/examples/02_sdk_concepts/06_transactions.py" target="_blank" style="float: right; padding: 6px 12px; background-color: #24292e; color: #ffffff; border-radius: 4px; text-decoration: none; font-size: 0.875rem; font-weight: 500;">View on GitHub</a>
