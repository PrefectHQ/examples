<a href="https://github.com/prefecthq/examples/blob/examples-markdown/examples/04_misc/03_tasks.py" target="_blank" style="float: right; padding: 6px 12px; background-color: #24292e; color: #ffffff; border-radius: 4px; text-decoration: none; font-size: 0.875rem; font-weight: 500;">View on GitHub</a>
