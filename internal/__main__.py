...
def main():
    parser = argparse.ArgumentParser(
        description="Prefect Examples internal tools", prog="python -m internal"
    )
    ...
    run_group.add_argument(
        "-e", "--example", help="Run a specific example by stem name or path"
    )
    run_group.add_argument(
        "-r", "--random", action="store_true", help="Run a random example"
    )
    run_group.add_argument(
    ...
    docs_parser = subparsers.add_parser(
        "generate-docs", help="Generate documentation from examples"
    )
