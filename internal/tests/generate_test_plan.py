...
def main():
    parser = argparse.ArgumentParser(description="Generate a test plan based on changed files")
    parser.add_argument(
        "--github-action", 
        action="store_true", 
    ...
    if args.github_action:
        ...
        parser.error("Must specify one of --github-action, --git-diff, or --changed-files")
